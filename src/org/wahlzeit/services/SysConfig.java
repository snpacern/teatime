...
public class SysConfig extends AbstractConfig {
	...
	public SysConfig(String myRootDir) {
		...
		doSetValue(SysConfig.DB_CONNECTION, "jdbc:postgresql://localhost:5432/cerny");
		doSetValue(SysConfig.DB_USER, "cerny");
		doSetValue(SysConfig.DB_PASSWORD, "UXAFWTTs6RO76TrT");
	}
